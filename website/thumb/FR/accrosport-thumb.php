<div id="thumb-accrosport" class="pres-pr">
	<a id="href-pres-accrosport"></a>
	<div class="pres-pr_container_left">
		<div class="date f-mpl_m">
			<span>SINCE SEPTEMBER 2013</span>
		</div>
		<div class="title f-mpl_3" style="color: #5a70d7;font-size: 54px;">
			<h2>ACCROSPORT</h2>
		</div>
		...
		<div class="more-details f-mpl_m">
			<a class="delay" href="http://agence-me.com/Website/Project/Accrosport">MORE DETAILS</a>
			<div></div>
		...
		<img class="work-img-accrosport-1" src="img/work-accrosport/accrosport-1.jpg">

		<img class="work-img-accrosport-2" src="img/work-accrosport/accrosport-2.jpg">
