<div id="thumb-petitbus" class="pres-pr">
	<a id="href-pres-petitbus"></a>
	<div class="pres-pr_container_left">
		<div class="date f-mpl_m">
			<span>MARS 2015</span>
		</div>
		<div class="title f-mpl_3" style="color: #16A9E5;font-size: 54px;">
			<h2>PETIT BUS</h2>
		</div>
		...
		<img class="work-img-petitbus-1" src="img/work-petitbus/petitbus-1.jpg">

		<img class="work-img-petitbus-2" src="img/work-petitbus/petitbus-2.jpg">

		<img class="work-img-petitbus-3" src="img/work-petitbus/petitbus-3.jpg">
