<div id="thumb-sponseasy" class="pres-pr">
	<a id="href-pres-sponseasy"></a>
	<div class="pres-pr_container_left">
		<div class="date f-mpl_m">
			<span>SINCE SEPTEMBER 2013</span>
		</div>
		<div class="title f-mpl_3" style="color: #F35F38;font-size: 54px;">
			<h2>SPONSEASY</h2>
		</div>
		<div class="description f-hn_r">
			Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. 
		</div>
		<div class="more-details f-mpl_m">
			<a class="delay" href="">MORE DETAILS</a>
			<div></div>
		...
		<img class="work-img-sponseasy-1" src="img/work-sponseasy/sponseasy-1.jpg">

		<img class="work-img-sponseasy-2" src="img/work-sponseasy/sponseasy-2.jpg">

		<img class="work-img-sponseasy-3" src="img/work-sponseasy/sponseasy-3.jpg">
